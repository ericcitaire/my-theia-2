# Generated by Powerlevel10k configuration wizard on 2021-06-08 at 21:14 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 51222.
# Wizard options: compatible, lean_8colors, unicode, 24h time, 2 lines, disconnected,
# no frame, compact, concise, instant_prompt=verbose.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 100 )) && branch[48,-48]="…"  # <-- this line
